(function() {
    ...
    switch (cdaSpot) {
        case "ad1":
            var cdaLink = 'https://elementor.com/pages/the-free-templates/?utm_source=codrops&utm_medium=banner&utm_campaign=codrops-custom-sidebar';
            var cdaImg = 'https://tympanus.net/codrops/wp-content/banners/Elementor_demo.jpg';
            var cdaImgAlt = 'Elementor';
            var cdaText = "Easily Create WordPress websites with Elementorâ€™s designer-made templates. Free cutting-edge templates for every niche.";
            break;
        case "ad2":
